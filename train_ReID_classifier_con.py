...
tf.app.flags.DEFINE_string('model_name', 'resnet_v1_distributions_baseline_50', 'The name of the architecture to train. resnet_v1_50, resnet_v1_distributions_50, resnet_v1_distributions_baseline_50')

tf.app.flags.DEFINE_boolean('entropy_loss', False, 'uncertainty loss')
tf.app.flags.DEFINE_integer('max_number_of_steps', 3, 'The maximum number of training steps.') # 20200
