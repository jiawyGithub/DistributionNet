...
python train_ReID_classifier_con.py --target market --dataset_name Market --set bounding_box_train_0.1_0  --checkpoint_path2 ./result/resnet_v1_50_targetmarket_noise_0.1_0_standard
...
python train_ReID_classifier.py --entropy_loss True --target market --dataset_name Market --set bounding_box_train_0.1_0 --checkpoint_path2 ./result/resnet_v1_50_targetmarket_noise_0.1_0_standard
...
python eval_market_multi.py --dataset_name Market --set bounding_box_train_0.1_0
